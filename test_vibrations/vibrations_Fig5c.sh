...
F_MIN_MAX_LIST=("50 51" "50 100" "100 101" "100 150" "150 200")

for F_MIN_MAX in "${F_MIN_MAX_LIST[@]}"; do
    read -r F_MAX_MIN F_MAX_MAX <<< "$F_MIN_MAX"
    echo "F_MIN: $F_MAX_MIN, F_MAX: $F_MAX_MAX"
    
    # vib_exp_id="vib_vary_multipleFs_vib_ia_only"
    vib_exp_id="vib_vary_multipleFs_fixFmax-${F_MAX_MIN}-${F_MAX_MAX}"
    echo "Vibration experiment ID: $vib_exp_id"
