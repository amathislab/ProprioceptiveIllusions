...
### Fig 3 ###
SEEDS=(0)
TRAINING_SEEDS=(0) # for models from the paper
...
VIB_START=200
VIB_END=900
I_A_SAMPLED_COEFF_PATH_BASE="data/spindle_coefficients/i_a/linear/"
I_A_COEFF_PATH="data/spindle_coefficients/i_a/linear/coefficients.csv"
TASK="letter_reconstruction_joints"
model_prefix="optimized_linear"
